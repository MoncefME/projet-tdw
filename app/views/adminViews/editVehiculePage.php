...
class EditVehiculePage
{
    ...
    private function showVehiculeFrom()
    {
        ...
        ?>
        <form method="POST" action="/CarLog/app/api/vehicules/editVehicule.php?vehiculeId=<?php echo $vehicule['id'] ?>"
            class="addVehicule-form" enctype="multipart/form-data">
            <div>
                <div>
                ...
                <div>
                    ...
                    <img id="previewImage" src="/CarLog/public/uploads/vehicles/<?php echo $vehicule['vehiculePicture'] ?>"
                ...
                <div>
                    ...
                    <textarea name="note" id="note" placeholder="Enter note"><?php echo $vehicule['note'] ?></textarea>
                </div>
            </div>
