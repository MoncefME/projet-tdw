...
(9, '$2y$10$ep12wzOYG/7agw7VA7NSL.lL9oM1VVlC3rgxNsfWTFFk.b6Dn6LRm', 'moncef@esi.dz', 'Moncef', 'Moussaoui', 'USER', '2002-07-29', 'MALE', 'PENDING', 'image.png'),
(12, '$2y$10$hBysh9AVEPguH4OBQCmvE.B1sq7z.9vXO9cXxm6/MDW6xolcWlfOu', 'halim@inh.dz', 'halim', 'moussaoui', 'USER', '2001-09-24', 'MALE', 'PENDING', 'Moncef.jpeg');
...
CREATE TABLE `vehicules` (
  ...
  `hight` decimal(8,2) DEFAULT NULL,
...
--
ALTER TABLE `brandreviews`
  ADD CONSTRAINT `brandreviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `brandreviews_ibfk_2` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`);
...
--
ALTER TABLE `vehiculereviews`
  ADD CONSTRAINT `vehiculereviews_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  ADD CONSTRAINT `vehiculereviews_ibfk_2` FOREIGN KEY (`vehicule_id`) REFERENCES `vehicules` (`id`);

--
-- Constraints for table `vehicules`
--
ALTER TABLE `vehicules`
  ADD CONSTRAINT `vehicules_ibfk_1` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`);
COMMIT;
